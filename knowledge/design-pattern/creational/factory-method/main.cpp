...
/**
 * Products provide various implementation of the Product interface.
 */
 ...
 * The subclasses of Creator usually provide the implementation of this method.
 *
 * Also note that, despite its name, the Creator's primary responsibility is not creating objects.
 * Usually, it contains some core business logic that relies on Product objects, returned by the factor method.
