...
void printHelp(int, char** argv)
{
  ...
  print_info("where option are: \n");
  print_info("     -copy_normals 0/1 : set to true (1) or false (0) if the output PointCLoud should contain or not.\n");
}
...
int main(int argc, char** argv)
{
  ...
  // Parse the command line arguments for .pcd and .obj file
